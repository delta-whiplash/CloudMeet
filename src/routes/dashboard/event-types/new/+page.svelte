...
<div class="min-h-screen bg-background">
	...
	<header class="sticky top-0 z-30 border-b border-border bg-surface/80 backdrop-blur-xl">
		<div class="mx-auto flex h-16 w-full max-w-3xl items-center gap-4 px-4 sm:px-6">
			...
			<h1 class="font-display text-lg font-semibold text-foreground">Create Event Type</h1>
		</div>
	</header>
						...
						<div class="border-t border-border pt-6">
							...
							<div class="mb-4 rounded-lg bg-surface-2 p-3 text-sm">
								<p class="mb-1 text-muted-foreground">
									<span class="font-medium text-foreground">Check availability from:</span> {getAvailabilityLabel(getDefaultAvailability())}
								</p>
								<p class="text-muted-foreground">
									<span class="font-medium text-foreground">Send invite via:</span> {getInviteLabel(getDefaultInviteCalendar())}
								</p>
